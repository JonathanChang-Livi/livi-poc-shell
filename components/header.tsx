...
const MobileHeader = () => {
    ...
    return (
        <div className="md:hidden w-full sticky top-0 flex flex-row justify-between p-4">
    ...
    return (
        <>
            <div className="w-full bg-gray-600 py-2 ">
                <div className="flex flex-row max-w-[1200px] justify-end m-auto">
                    <Group spacing="xl">
            ...
            <div className="w-full bg-slate-300 drop-shadow-md filter-none">
                <div className="flex flex-row max-w-[1200px] justify-between m-auto">
