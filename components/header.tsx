...
const MobileHeader = () => {
    ...
    return (
        <div className="md:hidden w-full sticky top-0 flex flex-row justify-between p-4 border border-slate-100 shadow-lg">
...
const DesktopHeader = () => {
    return (
        <>
            <div className="w-full bg-gray-600 py-2 hidden md:block">
                <div className="flex flex-row max-w-[1200px] mx-4 justify-end m-auto">
                    <Group spacing="xl">
            ...
            <div className="w-full bg-slate-300 drop-shadow-md filter-none hidden md:block">
                <div className="flex flex-row max-w-[1200px] mx-4 justify-between m-auto">
